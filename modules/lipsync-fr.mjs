/**
 * @class French lip-sync processor (Fixed version)
 * @author Assistant
 */
...
class LipsyncFr {
    ...
    constructor() {
        ...
        this.rules = {
            'A': [
                "[AIENT]=E", "[AIN]=E", "[AIM]=E", "[AU]=O", "[AY]=E I",
                "[AN]=aa", "[AM]=aa", "[AI]=E", "[A]=aa"
            ],
            ...
            'C': [
                "[CH]=SS", "[C]E=SS", "[C]I=SS", "[C]Y=SS", "[C]=kk"
            ],
